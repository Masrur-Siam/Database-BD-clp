...
--
-- Host: localhost
-- Generation Time: Feb 25, 2026 at 08:57 AM
...
INSERT INTO `DEPARTMENT` (`department_id`, `dept_name`, `country_id`) VALUES
(1, 'CSE', 1),
(2, 'TXT', 2);
...
--
ALTER TABLE `FOLDER`
  ADD CONSTRAINT `FOLDER_ibfk_1` FOREIGN KEY (`employee_id`) REFERENCES `EMPLOYEE` (`emp_id`);
--
-- Database: `Fake`
--
CREATE DATABASE IF NOT EXISTS `Fake` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `Fake`;
--
-- Database: `green`
--
...
INSERT INTO `students` (`student_id`, `name`, `email`, `phone`, `dept_id`) VALUES
(101, 'John Doe', 'john@example.com', '1111111111', 1),
(102, 'Jane Smith', 'jane@example.com', '2222222222', 2),
(103, 'Mike Brown', 'mike@example.com', '3333333333', 3),
(104, 'Sara Ali', 'sara@example.com', '4444444444', 4),
(105, 'David Kim', 'david@example.com', '5555555555', 5);
...
-- Database: `Gub`
--
CREATE DATABASE IF NOT EXISTS `Gub` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `Gub`;
--
-- Database: `phpmyadmin`
--
...
('root', '[{\"db\":\"green\",\"table\":\"courses\"},{\"db\":\"green\",\"table\":\"students\"},{\"db\":\"green\",\"table\":\"departments\"},{\"db\":\"green\",\"table\":\"enrollments\"}]');
...
('root', '2026-02-25 07:14:52', '{\"Console\\/Mode\":\"collapse\"}');
